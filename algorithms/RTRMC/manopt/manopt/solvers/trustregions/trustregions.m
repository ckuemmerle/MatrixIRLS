...
%
% =========================================================================
% Difference to version in Manopt 6.0:
% Minor modification of of function "savestats" below to save intermediate
% iterates.
% Modification by Christian Kuemmerle
% =========================================================================
...
function stats = savestats(problem, x, storedb, key, options, k, fx, ...
    ...
    % fully executed.
    % =====================================================================
    %%% Modification by Christian Kuemmerle, 2020
    if isfield(options,'saveiterates') && options.saveiterates == 1
        store = storedb.getWithShared(key);
        stats = options.recorditerates(problem, x, stats, store);
    end
    % =====================================================================
