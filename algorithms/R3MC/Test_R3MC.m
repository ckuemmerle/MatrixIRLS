...
true_rank = 10;
over_sampling = 4.0;
CN = 10^5 ; 200; 300; 500; % Condition number

fprintf('Rank %i matrix of size %i times %i and OS = %i\n', true_rank, d1, d2, over_sampling);

tol = 1e-10; % Tolerance; Look at the R3MC file to stop R3MC in a differente way
...
beta_type = 'H-S'; % Algorithm type. Other choices include H-S, F-R and off
