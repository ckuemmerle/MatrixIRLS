...
% "run_experiment_ICML2021_Figure2.m".
clear all;
...
load(['MCsamplecomp_d1_1000_d2_1000_r_5_kappa_100000_2021-06-01_02-35-02_rho1.05-4.mat'])
alg_names_experiment1 = [alg_names_experiment1(1:3),alg_names(1),alg_names_experiment1(4:end)];
median_err_rel_experiment1 = [median_err_rel_experiment1(1:3,:);...
    median_err_rel(1,:);median_err_rel_experiment1(4:end,:)];
...
save_filename=strcat('experiment_MCalgos_ICML2021_Fig2_samplesvsmedian_kappa100000');
