% This script plots the experimental data of Figure 5 contained in the
% paper
...
% "run_experiment_ICML2021_Figure5.m".
clear all;
...
median_err_rel_experiment1 = median_err_rel([1],:);
alg_names_experiment1 = alg_names([1]);
load(['MCsamplecomp_d1_1000_d2_1000_r_5_kappa_10_2021-05-31_23-13-57_rho1.05-4.mat'])
median_err_rel_combined(1,:) =  median_err_rel_experiment1(1,:);
median_err_rel_combined(2,:) =  median_err_rel(1,:);
alg_names_combined = alg_names_experiment1(1);
...
save_filename=strcat('experiment_MCalgos_ICML2021_Fig5_samplesvsmedian_kappa10_rankada');
