% This script reproduces the experiment of Figure 6 of the paper
...
instancesize = 50; 
alg_names = {'MatrixIRLS','R3MC-rankupd','LRGeomCG_pursuit'}; 
problem =struct; 
problem.d1 = 1000; 
problem.d2 = 1000; 
problem.r = 5; 
...
save('results/experiment_MCalgos_ICML2021_Fig6_samplesvsmedian_kappa100000.mat')